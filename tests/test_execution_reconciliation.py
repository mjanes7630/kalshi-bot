...
from kalshi_bot.api.models import KalshiContractSide, KalshiOrder, KalshiOrderSide
...
def test_reconcile_orders_does_nothing_when_resting_orders_match_desired_quotes() -> (
    ...
    resting_bid.side = KalshiContractSide.YES
    resting_bid.book_side = KalshiOrderSide.BID
    ...
    resting_ask.side = KalshiContractSide.YES
    resting_ask.book_side = KalshiOrderSide.ASK
...
def test_reconcile_orders_replaces_resting_order_that_differs_from_desired_quote() -> (
    ...
    stale_resting_bid.side = KalshiContractSide.YES
    stale_resting_bid.book_side = KalshiOrderSide.BID
...
def test_reconcile_orders_replaces_partially_filled_order() -> None:
    ...
    partially_filled_bid.side = KalshiContractSide.YES
    partially_filled_bid.book_side = KalshiOrderSide.BID
...
def test_reconcile_orders_cancels_duplicate_resting_order() -> None:
    ...
    first_resting_bid.side = KalshiContractSide.YES
    first_resting_bid.book_side = KalshiOrderSide.BID
    ...
    duplicate_resting_bid.side = KalshiContractSide.YES
    duplicate_resting_bid.book_side = KalshiOrderSide.BID
...
def test_reconcile_orders_replaces_resting_order_from_different_market() -> None:
    ...
    other_market_bid.side = KalshiContractSide.YES
    other_market_bid.book_side = KalshiOrderSide.BID
